...
config.plugins.hyperioncontrol.smoothingupdateFrequency = ConfigSelection(choices=[("20","20 Hz"),("25","25 Hz"),("30","30 Hz")], default = "20")
...
config.plugins.hyperioncontrol.framegrabberFreq = NoSave(ConfigSelectionNumber(10,25,5,default = 10))
...
config.plugins.hyperioncontrol.deviceType = ConfigSelection(choices=[("udpraw","UDPRaw"),("sedu","Sedulight"),("adalight","Adalight"),("karatelight","Karatelight"),("atmo","Atmolight"),("philipshue","PhilipsHue"),("philipshueentertainment","PhilipsHueEntertainment")], default = "udpraw")
...
config.plugins.hyperioncontrol.baudrate = ConfigSelection(choices=[("38400","38.400"), ("50000","50.000"), ("57600","57.600"), ("100000","100.000"),("115200","115.200"), ("150000","150.000"), ("200000","200.000"), ("250000","250.000"), ("460800","460.800"), ("500000","500.000")], default = "200000")
